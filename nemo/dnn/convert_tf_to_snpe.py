...
if __name__ == '__main__':
    ...
    if args.train_type == 'train_video':
        ...
        checkpoint_dir = os.path.join(args.data_dir, args.content, 'checkpoint', args.lr_video_name, f"{model.name}_finetune")  # 修改位置 2: 使用 f-string
        log_dir = os.path.join(args.data_dir, args.content, 'log', args.lr_video_name, f"{model.name}_finetune")  # 修改位置 3: 使用 f-string
