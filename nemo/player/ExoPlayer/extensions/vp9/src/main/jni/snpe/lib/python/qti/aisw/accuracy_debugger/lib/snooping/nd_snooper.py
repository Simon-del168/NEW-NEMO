...
class Snooper:
    ...
    def get_tensor_mapping(self):
        ...
        get_mapping_arg = Namespace(
            None, framework=self.framework, version=self.framework_version,
            model_path=self.model, output_dir=self.output_dir,
            engine=self.engine, golden_dir_for_mapping=None,
            converter_params=converter_params, engine_path=self.engine_path, host_device=self.host_device)
