...
def run_ort_inference(model: ModelProto, input_data: Dict[Text, np.ndarray], output_node_names: List[Text], custom_lib: Optional[Text] = None) -> Tuple[bool, Dict[Text, np.ndarray]]:
    """
