...
#
CC :=/home/hyz/Android/Sdk/ndk/26.2.11394342/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android31-clang
CXX :=/home/hyz/Android/Sdk/ndk/26.2.11394342/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android31-clang++
AR := /home/hyz/Android/Sdk/ndk/26.2.11394342/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ar
LD := /home/hyz/Android/Sdk/ndk/26.2.11394342/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ld
...
#    SNPE_ROOT := $(LOCAL_PATH)/libvpx/third_party/snpe
    ...
    ifeq ($(TARGET_ARCH_ABI), arm64-v8a)
        ...
        ifeq ($(APP_STL), c++_shared)
           SNPE_LIB_DIR := $(SNPE_ROOT)/lib/arm-android
        else
           $(error Unsupported APP_STL: '$(APP_STL)')
        endif
    else
