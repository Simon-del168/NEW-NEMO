...
class BackendInfoConfig(AISWBaseModel):
    backend: str = Field(description="Option to specify the backend on which the model needs to "
                                     "run. Providing this option will generate a graph optimized "
                                     "for the given backend.")
    soc_model: str = Field(default="", description="Option to specify the SOC on which the model "
