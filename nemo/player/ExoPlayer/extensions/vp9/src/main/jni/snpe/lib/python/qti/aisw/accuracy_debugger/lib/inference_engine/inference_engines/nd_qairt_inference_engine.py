...
from qti.aisw.accuracy_debugger.lib.utils.nd_verifier_utility import get_tensor_names_from_dlc, get_dlc_size, get_intermediate_tensors_size_from_dlc, divide_output_tensors
...
class QAIRTInferenceEngine(InferenceEngine):
    ...
    def _execute_qnn_inference(self, dlc_data):
        ...
        add_layer_outputs = ','.join(self.add_layer_outputs) if self.add_layer_outputs else None
        execute_command = self.executor.build_execute_command(
