...
class QuantizerInputConfig(AISWBaseModel):
    ...
    weights_bitwidth: Literal[8, 4] = Field(default=8,
                                            description="Option to select the bitwidth to use when"
                                                        "quantizing the weights, either 4 or 8 ("
                                                        "default).")
    ...
    use_aimet_quantizer: bool = Field(default=False,
                                      description="Use AIMET for Quantization instead of"
                                                  " QNN IR quantizer.")

    config_file: Optional[FilePath] = Field(default=None, description="Use this argument to pass "
                                                                      "the path of the config "
                                                                      "YAML file with quantizer"
                                                                      " options.")
    ...
    param_quantizer_schema: quant_schema = Field(default="asymmetric",
                                                 description="Specify which quantization schema to "
                                                             "use for activations supported values:"
                                                             " asymmetric (default), symmetric")
