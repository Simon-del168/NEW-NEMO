...
CC :=/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android31-clang
CXX :=/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android31-clang++
...
ifeq ($(CONFIG_SNPE), yes)
	...
	SNPE_INCLUDE_DIR:= $(SNPE_ROOT)/include
...
LOCAL_CFLAGS := -DENABLE_GL_BUFFER
	...
	LOCAL_C_INCLUDES += $(LOCAL_PATH)/snpe/include
...
ifeq ($(CONFIG_SNPE), yes)
	...
	LOCAL_EXPORT_C_INCLUDES += $(LOCAL_PATH)/snpe/include
